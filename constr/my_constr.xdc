...
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { position }]; #IO_L24N_T3_34 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { servo }]; #IO_L1N_T0_34 Sch=jc_n[2]              
